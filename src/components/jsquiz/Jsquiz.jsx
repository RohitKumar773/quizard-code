...
import { jsData } from "../../assets/data";
import "../../App.css";
import "../html/htmlquiz.css";
import ReactConfetti from "react-confetti";
import { NavLink } from "react-router-dom";

const Jsquiz = () => {
  let [index, setIndex] = useState(0);
  let [question, setQuestion] = useState(jsData[index]);
          ...
          {result ? (
            <>
              <div className="w-full h-[400px] float-left">
                ...
                <h2 className="text-center leading-10">
                  Wrong Answer : {jsData.length - score}
                </h2>
