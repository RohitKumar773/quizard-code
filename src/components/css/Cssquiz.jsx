...
import { cssData } from "../../assets/data";
import "../../App.css";
// import "./htmlquiz.css";
...
const Cssquiz = () => {
  ...
  let [question, setQuestion] = useState(cssData[index]);
            ...
            <>
              <div className="w-full h-[400px] float-left">
                <h2 className="text-center leading-10">
                  Total Questions : {cssData.length}
                </h2>
                ...
                <h2 className="text-center leading-10">
                  Wrong Answer : {cssData.length - score}
                </h2>
